...
#include <PostCompositeObjectPipeline.h>
#include <Logger.h>
#include <Shader.h>

bool PostCompositeObjectPipeline::init(VkRenderData& renderData, std::vector<VkFormat> colorAttachmentFormats,
  ...
  VkPipelineRenderingCreateInfo pipelineRenderingCreateInfo {
    ...
    .depthAttachmentFormat = renderData.rdDepthBufferData.format,
  };
...
void PostCompositeObjectPipeline::cleanup(VkRenderData &renderData, VkPipeline &pipeline) {
