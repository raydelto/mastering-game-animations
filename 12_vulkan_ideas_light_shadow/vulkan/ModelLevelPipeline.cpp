...
bool ModelLevelPipeline::init(VkRenderData& renderData, std::vector<VkFormat> colorAttachmentFormats,
...
void ModelLevelPipeline::cleanup(VkRenderData &renderData, VkPipeline &pipeline) {
