...
bool UserInterface::init(VkRenderData& renderData) {
  ...
  imguiIinitInfo.PipelineRenderingCreateInfo.depthAttachmentFormat = renderData.rdDepthBufferData.format;
...
void UserInterface::createDescriptorSets(VkRenderData& renderData) {
  ...
  renderData.rdGBuffer.color.descriptorSet = ImGui_ImplVulkan_AddTexture(renderData.rdGBuffer.color.sampler, renderData.rdGBuffer.color.uiImageView, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
  renderData.rdGBuffer.depth.descriptorSet = ImGui_ImplVulkan_AddTexture(renderData.rdGBuffer.depth.sampler, renderData.rdGBuffer.depth.uiImageView, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
  renderData.rdGBuffer.normal.descriptorSet = ImGui_ImplVulkan_AddTexture(renderData.rdGBuffer.normal.sampler, renderData.rdGBuffer.normal.uiImageView, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
  renderData.rdSelectionImageData.descriptorSet = ImGui_ImplVulkan_AddTexture(renderData.rdSelectionImageData.sampler, renderData.rdSelectionImageData.uiImageView, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
  ...
  renderData.rdSSAOColorBufferData.descriptorSet = ImGui_ImplVulkan_AddTexture(renderData.rdSSAOColorBufferData.sampler, renderData.rdSSAOColorBufferData.uiImageView, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
  renderData.rdSSAOBlurBufferData.descriptorSet = ImGui_ImplVulkan_AddTexture(renderData.rdSSAOBlurBufferData.sampler, renderData.rdSSAOBlurBufferData.uiImageView, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
  renderData.rdDynamicLightCombinedShadowData.descriptorSet = ImGui_ImplVulkan_AddTexture(renderData.rdDynamicLightCombinedShadowData.sampler, renderData.rdDynamicLightCombinedShadowData.uiImageView, VK_IMAGE_LAYOUT_DEPTH_STENCIL_READ_ONLY_OPTIMAL);
  renderData.rdLightSpheresBufferData.descriptorSet = ImGui_ImplVulkan_AddTexture(renderData.rdLightSpheresBufferData.sampler, renderData.rdLightSpheresBufferData.uiImageView, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
  renderData.rdShadowMapCombinedDepthBufferData.descriptorSet = ImGui_ImplVulkan_AddTexture(renderData.rdShadowMapCombinedDepthBufferData.sampler, renderData.rdShadowMapCombinedDepthBufferData.uiImageView, VK_IMAGE_LAYOUT_DEPTH_STENCIL_READ_ONLY_OPTIMAL);
}
...
void UserInterface::createSettingsWindow(VkRenderData& renderData, ModelInstanceCamData& modInstCamData) {
  ...
  if (ImGui::CollapsingHeader("Dynamic Light")) {
    ...
    ImGui::Text("Const. Depth Bias:");
    ImGui::SameLine();
    ImGui::SliderFloat("##DynLightShadowMapConstantDepthBias", &renderData.rdDynLightShadowMapConstantDepthBias, 0.0f, 5.0f, "%.6f", flags);

    ImGui::AlignTextToFramePadding();
    ImGui::Text("Slope Depth Bias: ");
    ImGui::SameLine();
    ImGui::SliderFloat("##DynLightShadowMapSlopeDepthBias", &renderData.rdDynLightShadowMapSlopeDepthBias, 0.0f, 5.0f, "%.6f", flags);

    ImGui::AlignTextToFramePadding();
    ImGui::Text("ShadowMap Offset: ");
    ImGui::SameLine();
    ImGui::SliderFloat("##DynLightShadowMapOffset", &lightSettings.dlsShadowMapOffset, 0.0f, 0.05f, "%.4f", flags);
...
void UserInterface::createDebugWindow(VkRenderData& renderData) {
  ...
  ImGui::Text("Depth");
  ImGui::Image(static_cast<ImTextureID>(renderData.rdGBuffer.depth.descriptorSet), ImVec2(imageWidth, imageHeight));

  ImGui::Text("Normal");
  ImGui::Image(static_cast<ImTextureID>(renderData.rdGBuffer.normal.descriptorSet), ImVec2(imageWidth, imageHeight));

  ImGui::Text("Selection");
  ImGui::Image(static_cast<ImTextureID>(renderData.rdSelectionImageData.descriptorSet), ImVec2(imageWidth, imageHeight));

  ImGui::Text("SSAO Noise");
  ImGui::Image(static_cast<ImTextureID>(renderData.rdSSAONoiseBufferData.descriptorSet), ImVec2(64, 64));

  ImGui::Text("SSAO Color");
  ImGui::Image(static_cast<ImTextureID>(renderData.rdSSAOColorBufferData.descriptorSet), ImVec2(imageWidth, imageHeight));
