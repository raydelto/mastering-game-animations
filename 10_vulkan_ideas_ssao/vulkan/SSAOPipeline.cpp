...
bool SSAOPipeline::init(VkRenderData& renderData, std::vector<VkFormat> colorAttachmentFormats,
...
void SSAOPipeline::cleanup(VkRenderData &renderData, VkPipeline &pipeline) {
