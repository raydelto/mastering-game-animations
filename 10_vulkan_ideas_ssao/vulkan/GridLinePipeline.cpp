...
bool GridLinePipeline::init(VkRenderData& renderData, std::vector<VkFormat> colorAttachmentFormats,
...
void GridLinePipeline::cleanup(VkRenderData &renderData, VkPipeline &pipeline) {
