...
struct VkRenderData {
  ...
  float rdOrhtoNearFar = 75.0f;

  bool rdEnableSSAO = true;
  bool rdEnableSSAOBlur = true;
  float rdSSAORadius = 10.0f;
  float rdSSAOBias = 0.2f;
  int rdSSAOExponent = 10;
  ...
  VkUniformBufferData rdSSAOSettingsUBO{};
