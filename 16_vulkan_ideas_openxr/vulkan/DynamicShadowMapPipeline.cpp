...
bool DynamicShadowMapPipeline::init(VkRenderData& renderData,
  ...
  // Enable dynamic depth bias for the shadow map pipeline
  std::vector<VkDynamicState> dynStates = { VK_DYNAMIC_STATE_VIEWPORT, VK_DYNAMIC_STATE_SCISSOR, VK_DYNAMIC_STATE_DEPTH_BIAS };
  ...
  pipelineRenderingCreateInfo.viewMask = kXRDynamicShadowMapViewMask;
...
void DynamicShadowMapPipeline::cleanup(VkRenderData &renderData, VkPipeline &pipeline) {
